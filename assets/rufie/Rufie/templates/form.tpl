<form>
    ...
    <input type="text" id="exercise__weight"
           class="exercise__weight {{= weightEmpty ? 'exercise__weight-error' : '' }}"/>
    ...
    <input type="text" id="exercise__repetitions"
           class="exercise__repetitions {{= repetitionsEmpty ? 'exercise__repetitions-error' : '' }}"/>
